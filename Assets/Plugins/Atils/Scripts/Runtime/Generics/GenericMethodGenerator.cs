...
namespace Atils.Runtime.Generics
{
	public static class GenericMethodGenerator
    {
        ...
        /// For a more detailed search for the required method, use the chain of methods from <see cref="GenericMethodProvider"/>.
        /// </summary>
        ...
        public static GenericMethodProvider GetGenericMethod(Type sourceClassType, string methodName, object sourceClassInstance)
		{
            return new GenericMethodProvider(sourceClassType, methodName, sourceClassInstance);
        }
    }
}
